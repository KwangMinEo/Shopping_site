...
<table width='700' border='1' cellspacing='0' cellpadding=5>
  ...
  <tr>
  	<td rowspan="5"  align="center" width=300> 
  	 <a href="download.do?fname=${dto.img_file_name}"> <img src="${pageContext.request.contextPath}/resources/upload/${dto.img_file_name}" height=200 width=300> </a>
  	</td>
  	<td> 고유번호 :${dto.hobby_idx}  </td>
  </tr>
